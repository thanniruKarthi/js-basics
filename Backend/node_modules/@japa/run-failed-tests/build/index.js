...
function runFailedTests(options) {
    ...
    return async function (config) {
        ...
        if (summary.tests?.length) {
            ...
            console.log(`${cliui_1.icons.pointer} ${cliui_1.logger.colors.dim('@japa/run-failed-tests')}: Running only ${cliui_1.logger.colors.cyan(`${summary.tests.length} failed test(s)`)}`);
            /**
