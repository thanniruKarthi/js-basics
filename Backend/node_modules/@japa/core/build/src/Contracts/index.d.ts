 ...
 */
export declare type TestHooksCleanupHandler<Context> = (error: null | any, test: Test<Context, any>) => Promise<any> | any;
/**
 * The function that can be registered as a test hook
 */
export declare type TestHooksHandler<Context> = (test: Test<Context, any>) => Promise<any> | any | TestHooksCleanupHandler<Context> | Promise<TestHooksCleanupHandler<Context>>;
/**
 * The cleanup function for group hooks
 */
export declare type GroupHooksCleanupHandler<Context> = (error: null | any, group: Group<Context>) => Promise<any> | any;
/**
 * The function that can be registered as a group hook
 */
export declare type GroupHooksHandler<Context> = (group: Group<Context>) => Promise<any> | any | GroupHooksCleanupHandler<Context> | Promise<GroupHooksCleanupHandler<Context>>;
/**
 * The cleanup function for suite hooks
 */
export declare type SuiteHooksCleanupHandler<Context> = (error: null | any, suite: Suite<Context>) => Promise<any> | any;
/**
 * The function that can be registered as a suite hook
 */
export declare type SuiteHooksHandler<Context> = (suite: Suite<Context>) => Promise<any> | any | SuiteHooksCleanupHandler<Context> | Promise<SuiteHooksCleanupHandler<Context>>;
/**
 ...
 */
export declare type ReporterContract = (runner: Runner<any>, emitter: Emitter) => void | Promise<void>;
/**
